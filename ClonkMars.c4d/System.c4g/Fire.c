...
global func AddFireEffect(int iDuration, int dwColor,bool bOverride, int iSize) {
  return(AddEffect("FireEffect",this,2,4,0,0, iDuration, dwColor, bOverride,iSize));
}
