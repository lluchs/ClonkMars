...
/* Einstellungen */
private func MaxSpeed(){return(20);}
...
public func ControlUp(){_inherited(...); if(IsActive())return(Start(COMD_Up));}
...
public func ControlUpdate(){if(IsActive())return(Start(GetComDir()));}
